...
public class TakeScreenshot {
	 ...
	 */
		...
		public void BrowserOpen() throws InterruptedException {
			try {
				fileLoc = new FileInputStream(System.getProperty("user.dir")+"Selenium_Assignments_Batch1\\src\\main\\resources\\Config\\config.properties");
				prop = new Properties();
				prop.load(fileLoc);
			}catch(Exception e) {
				e.printStackTrace();
		...
		{
			takeSnapShot(driver,"C:\\Users\\darsir\\workspace\\SeleniumAssignments\\test-output\\Search.png");
		}
		@AfterTest
		public void logout()
		{
